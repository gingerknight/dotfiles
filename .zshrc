...
# Created by `pipx` on 2024-06-24 03:05:09
...
# -------- VENV Prompt -------
# Show virtual environment in the prompt with Catppuccin Mocha colors
if [[ -n "$VIRTUAL_ENV" ]]; then
    export PS1="%F{rosewater}(`basename \"$VIRTUAL_ENV\"`)%f $PS1"
fi
...
[ -f "/Users/ryan/.ghcup/env" ] && . "/Users/ryan/.ghcup/env" # ghcup-env
# pnpm
...
# bun completions
[ -s "/Users/ryan/.oh-my-zsh/completions/_bun" ] && source "/Users/ryan/.oh-my-zsh/completions/_bun"
